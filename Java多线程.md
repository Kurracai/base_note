...
**线程**是由操作系统管理的独立执行路径。每个线程有自己的执行上下文，包括程序计数器、栈、寄存器等。线程的调度和上下文切换由操作系统内核负责，这种切换是抢占式的，线程之间的切换会导致一定的性能开销（例如缓存失效、上下文保存和恢复）。

* **特点** ：
  * **内核级别管理** ：由操作系统内核调度。
  * **抢占式调度** ：操作系统决定何时切换线程。
  * **独立栈** ：每个线程有自己的栈。
  * **开销较大** ：线程的创建、销毁和上下文切换的开销较大。
  * **并行执行** ：多个线程可以真正并行执行，尤其是在多核处理器上。

##### 协程 (Coroutine)

**协程**是一种轻量级的用户态线程，由应用程序自己管理。协程的上下文切换是协作式的，也就是说，协程主动让出执行权。这种切换比线程切换更高效，因为它不涉及内核的上下文切换，只需保存和恢复少量的状态信息。

* **特点** ：
  * **用户级别管理** ：由程序库或应用程序自行管理。
  * **协作式调度** ：协程主动让出控制权（通过 `yield`、`await` 等操作）。
  * **共享栈** ：协程通常共享同一个栈，只在需要的时候保存和恢复上下文。
  * **开销较小** ：创建、销毁和切换的开销非常小。
  * **并发执行** ：多个协程在单线程中并发执行，依靠调度器来管理。
...
1. **调度机制** ：
   ...
   * **协程** ：由用户程序调度，是协作式的。
2. **上下文切换** ：
   * **线程** ：上下文切换涉及操作系统的内核态和用户态切换，开销较大。
   * **协程** ：上下文切换在用户态进行，开销较小。
3. **栈空间** ：
   * **线程** ：每个线程有独立的栈空间。
   * **协程** ：协程通常共享栈空间，只在需要时保存和恢复状态。
4. **并行与并发** ：
   * **线程** ：可以在多核处理器上实现真正的并行执行。
   * **协程** ：在单线程中实现并发执行，但不是真正的并行。
5. **资源消耗** ：
   * **线程** ：创建和维护线程的资源消耗较高。
   * **协程** ：非常轻量级，资源消耗极低。
...
![1722004609274.png](./1722004609274.png)
...
详情参考：[偏向锁小结（执行流程，批量重偏向和批量撤销）_批量撤销 偏向锁-CSDN博客](https://blog.csdn.net/Nanami77777773/article/details/132977198#:~:text=%E6%89%B9%E9%87%8F%E9%87%8D%E5%81%8F%E5%90%91%20%E9%A6%96%E5%85%88%EF%BC%8C%20%E4%B8%80%E5%BC%80%E5%A7%8B%E5%B9%B6%E4%B8%8D%E4%BC%9A%E5%BC%80%E5%90%AF%E9%87%8D%E5%81%8F%E5%90%91%20%EF%BC%88%E6%84%8F%E5%91%B3%E7%9D%80%E4%B8%80%E6%9C%89%E7%AB%9E%E4%BA%89%E5%B0%B1%E4%BC%9A%E6%92%A4%E9%94%80%E5%81%8F%E5%90%91%E9%94%81%E5%8D%87%E7%BA%A7%E4%B8%BA%E8%BD%BB%E9%87%8F%E7%BA%A7%E9%94%81%EF%BC%89%EF%BC%8C%E5%BD%93%E7%B4%AF%E8%AE%A1%E6%92%A4%E9%94%80%E6%AC%A1%E6%95%B0%E8%BE%BE%E5%88%B0%E9%98%88%E5%80%BC%E6%AC%A1%E6%95%B0%EF%BC%8820%E6%AC%A1%EF%BC%89%E7%9A%84%E6%97%B6%E5%80%99%EF%BC%8C%E6%89%8D%E4%BC%9A%E5%85%81%E8%AE%B8%E9%87%8D%E5%81%8F%E5%90%91%EF%BC%88%E8%AE%BE%E4%B8%BA%E5%8C%BF%E5%90%8D%E5%81%8F%E5%90%91%E7%8A%B6%E6%80%81%EF%BC%8C%E7%BA%BF%E7%A8%8B%E8%83%BD%E5%A4%9F%E8%8E%B7%E5%8F%96%E5%88%B0%E5%81%8F%E5%90%91%E9%94%81%EF%BC%89%EF%BC%8C%E9%87%8D%E7%BD%AE%E5%AF%B9%E8%B1%A1%E5%A4%B4%E7%9A%84%20Thread,ID%E3%80%82%20%E6%89%80%E4%BB%A5%E5%89%8D19%E6%AC%A1%E7%9A%84%E9%94%81%E6%92%A4%E9%94%80%E9%83%BD%E4%BC%9A%E6%8A%8A%E9%94%81%E5%8D%87%E7%BA%A7%E6%88%90%E8%BD%BB%E9%87%8F%E7%BA%A7%E9%94%81%EF%BC%88%E6%97%A0%E6%B3%95%E9%80%86%E8%BD%AC%EF%BC%89%EF%BC%8C%E4%B9%8B%E5%90%8E%E7%9A%84%E5%90%8C%E7%B1%BB%E5%81%8F%E5%90%91%E9%94%81%E5%AF%B9%E8%B1%A1%E6%89%8D%E4%BC%9A%E6%89%A7%E8%A1%8C%E9%87%8D%E5%81%8F%E5%90%91%20%E6%89%B9%E9%87%8F%E6%92%A4%E9%94%80%20%E6%89%B9%E9%87%8F%E9%87%8D%E5%81%8F%E5%90%91%E7%9A%84%E9%87%8D%E5%81%8F%E5%90%91%E5%8F%AA%E6%9C%89%E4%B8%80%E6%AC%A1%E6%9C%BA%E4%BC%9A%20%EF%BC%8C%E5%90%AF%E5%8A%A8%E9%87%8D%E5%81%8F%E5%90%91%E5%90%8E%E7%B4%AF%E8%AE%A1%E6%89%A7%E8%A1%8C%E6%92%A4%E9%94%80%E7%9A%84%E6%AC%A1%E6%95%B0%E8%BE%BE%E5%88%B0%E9%98%88%E5%80%BC%EF%BC%8840%E6%AC%A1%EF%BC%8C%E4%B9%9F%E5%B0%B1%E6%98%AF%E9%87%8D%E5%81%8F%E5%90%91%E5%90%8E%E5%86%8D20%E6%AC%A1%EF%BC%89%E5%90%8E%EF%BC%8C%E6%89%B9%E9%87%8F%E6%92%A4%E9%94%80%EF%BC%8C%E5%BD%93%E5%89%8D%E7%B1%BB%E7%9A%84%E6%89%80%E6%9C%89%E5%AF%B9%E8%B1%A1%E9%94%81%E5%9D%87%E5%8D%87%E7%BA%A7%E8%BD%BB%E9%87%8F%E7%BA%A7%E9%94%81%EF%BC%8C%E6%96%B0%E5%88%9B%E5%BB%BA%E7%9A%84%E8%AF%A5%E7%B1%BB%E5%AF%B9%E8%B1%A1%E5%A4%B4%E4%B9%9F%E6%98%AF%E6%97%A0%E9%94%81%E4%B8%8D%E5%8F%AF%E5%81%8F%E5%90%91%E7%8A%B6%E6%80%81%E3%80%82)
...
[批量重偏向和批量撤销理解-CSDN博客](https://blog.csdn.net/qq_33553218/article/details/107699356)

* 批量重偏向：（此时已经是轻量级锁了）当撤销偏向锁阈值超过 20 次后，JVM 会觉得是不是偏向错了，于是在给这些对象加锁时重新偏向至加锁线程
* 批量撤销：当撤销偏向锁阈值超过 40 次后，JVM 会觉得自己确实偏向错了，根本就不该偏向，于是整个类的所有对象都会变为不可偏向的，新建的对象也是不可偏向

**锁消除*

当觉得不会出现溢出的时候，比如数据来源于局部变量，且全部在一个方法中且没有溢出时候。
...
* 线程节点加入队列成功，进入 AbstractQueuedSynchronizer#acquireQueued 逻辑阻塞线程
  ...
  * 如果当前线程是在 head 节点后，会再次 tryAcquire 尝试获取锁，state 仍~~~~为 1 则失败（第三次）
